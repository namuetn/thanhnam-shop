                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_name_vi" value="{{ old('product_name_vi') }}" class="form-control" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_quanlity" value="{{ old('product_quanlity') }}" class="form-control" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_en" value="{{ old('product_tags_en', 'Lorem,Ipsum,Amet') }}" data-role="tagsinput" class="form-control" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_vi" value="{{ old('product_tags_vi', 'Lorem,Ipsum,Amet') }}" data-role="tagsinput" class="form-control" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_en" value="{{ old('product_size_en', 'Small,Medium,Large') }}" data-role="tagsinput" class="form-control" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_vi" value="{{ old('product_size_vi', 'Small,Medium,Large') }}" data-role="tagsinput" class="form-control" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_en" value="{{ old('product_color_en', 'Red,Black,Amet') }}" data-role="tagsinput" class="form-control" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_vi" value="{{ old('product_color_vi', 'Red,Black,Amet') }}" data-role="tagsinput" class="form-control" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="short_description_en" id="textarea" class="form-control">{{ old('short_description_en') }}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="short_description_vi" id="textarea" class="form-control">{{ old('short_description_vi') }}</textarea>
